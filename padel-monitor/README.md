...
- **Влиять на подбор без кода** — пишите в `pi/preferences.md` свободным
  текстом: вкусы, вето («не предлагать ТЦ»), статусы по вариантам
  (`watch 175`, `отпало 220: колонны`). Судья читает файл каждый отчёт.
